...
var jiraAPI = {
      ...
      getCurrentUser : function (callback) {
        $.get('http://jira.brandingbrand.com/rest/gadget/1.0/currentUser').done(callback);
      },
      ...
      getUserTickets : function (callback, userName) {
        ...
        var query = {
            ...
            $.get('http://jira.brandingbrand.com/rest/api/2/search', query).done(function (response) {
      ...
      getAgileBoardSummary : function (rapidViewId, callback) {
          $.get('http://jira.brandingbrand.com/rest/greenhopper/1.0/xboard/plan/backlog/data.json?rapidViewId=' + rapidViewId).done(function (response) {
      ...
      getTickets : function (tickets, callback) {
         var jql  = 'key in ("' + tickets.join('","') + '")'
          ...
          $.get('http://jira.brandingbrand.com/rest/api/2/search', query).done(callback);
      }
    }
