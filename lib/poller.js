...
function Poller (functionSet) {
  this.frequency    = TENTHSEC; // when active poll every 100 miliseconds
  this.timeout      = HALFMIN;  // after this timeout, cease polling until an event is detected
