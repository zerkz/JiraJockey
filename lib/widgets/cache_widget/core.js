  ...
  console.log(ticket)
      ...
      if (ticket.fields) {
        ...
        if (fields.status) {
          ...
          workflowId  = workFlow.toLowerCase().replace(/\s+/g, '-')
        ...
        if (fields.assignee) {
          ...
          assigneeImg = assignee.displayName
